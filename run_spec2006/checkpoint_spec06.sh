...
#create simpoint checkpoint1 is copying the nessary running files to another directory
...
warmup_length=10000000	#10 million

gem5_output_dir=/home/chw/gem5/checkpoint_$ISA
gem5_args="--maxinsts=$max_inst --cpu-type=NonCachingSimpleCPU \
...
#simpoint parameters
simpoint_dir=/home/chw/gem5/simpoint_$ISA/$target/$ISA-$target-"input"$2
simpoint_file=$simpoint_dir/simpoint_file
weight_file=$simpoint_dir/weight_file
# --take-simpoint-checkpoint=<simpoint file path>,<weight file path>,<interval length>,<warmup length> 
gem5_args=$gem5_args" 
		--take-simpoint-checkpoint=$simpoint_file,$weight_file,$simpoint_interval,$warmup_length \
		--checkpoint-dir=$gem5_output_dir"
		
#copy the simpoint to the checkpoint dir
cp $simpoint_dir/simpoint_file $gem5_output_dir/simpoint_file
cp $simpoint_dir/weight_file $gem5_output_dir/weight_file
