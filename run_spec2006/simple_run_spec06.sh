...
warmup_inst=100000000 # 100 million
max_inst=1000000000 # 1 billion

gem5_output_dir=/home/chw/gem5/spec2016_result_$ISA

gem5_args="--num-cpus=1 --cpu-type=DerivO3CPU --mem-size=8GB \
        --caches --l1d_size=32kB --l1d_assoc=8 --l1i_size=32kB --l1i_assoc=8 \
        --l2cache --l2_size=2MB --l2_assoc=16 \
		--maxinsts=$max_inst --fast-forward=$warmup_inst"
